    ...
    switch (action.type) {
        case actions_1.ADD_TO_CART:
            ...
            if (state.cart.includes(action.product)) {
                ...
                return Object.assign(Object.assign({}, state), { cart: state.cart.concat(action.product), quantity: state.quantity.map((value, i) => {
            ...
            break;
        case actions_2.REMOVE_FROM_CART:
            return Object.assign(Object.assign({}, state), { cart: state.cart.filter(item => item !== action.product) });
        case actions_3.INCREASE_PRODUCT_COUNT:
            ...
            return Object.assign(Object.assign({}, state), { quantity: state.quantity.map((value, i) => {
                    if (action.product.id - 1 === i) {
                        return value += 1;
                    }
                    return value;
                }) });
        case actions_4.DECREASE_PRODUCT_COUNT:
